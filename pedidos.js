(function () {
    ...
    angular.module('appname.stock.pedidos', ['ngRoute', 'toastr',
    ...
    PedidosController.$inject = ['$routeParams', 'ProductService', 'PedidoService', 'toastr', '$location', '$window',
        'UserService', 'PagoProveedoresPedidoService', 'SucursalesService', 'ProductVars', 'PedidoVars'];
    function PedidosController($routeParams, ProductService, PedidoService, toastr, $location, $window,
                               UserService, PagoProveedoresPedidoService, SucursalesService, ProductVars, PedidoVars) {
            ...
            if (vm.pedido_faltante_id === -1) {
                ...
                PedidoService.create(vm.nuevoPedido, function (data) {
                    ...
                    PedidoService.update(vm.pedido, function (data) {
                        toastr.success('Pedido creado con �xito');
                        $location.path('/listado_pedidos');
                        //console.log(data);
                    })
                })
